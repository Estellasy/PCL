...
def main(resume):
    ...
    model = pcl.detection_builder.DetectionCL(models.__dict__[arch], low_dim, pcl_r, moco_m, temperature, mlp)
    # print(model)
    model = model.cuda()
    ...
    val_dataloader = dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root='/mnt/f/CL_for_Real/mmpretrain/data/hg',
            split='val',
...
if __name__ == "__main__":
    resume = 'exp/8_9_10/checkpoint_0099.pth.tar'
    main(resume)